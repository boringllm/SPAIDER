...
| **Add a Kali offensive tool** | `../kali_server/tools/*.py` (decorate an async handler, set its `_meta.category`). | Surfaces in Spider as `kali__<name>` via `tools/mcp.build_mcp_tools`. |
