"""Spider — LLM-driven autonomous penetration-testing framework.
...
authorised penetration test. Spider keeps a human in the loop: plans can require operator
...
Offensive tooling runs inside a dedicated Kali container exposed to Spider as an
